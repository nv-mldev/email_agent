        ...
        <Container maxWidth="xl" sx={{ py: 4 }}>
            ...
            <Box sx={{ mb: 4 }}>
                <Typography variant="h4" component="h1" gutterBottom>
                    📧 Email Agent Review Dashboard
                </Typography>
                <Box sx={{ display: 'flex', gap: 2, alignItems: 'center', mb: 2 }}>
                    <Button
                        variant="contained"
                        startIcon={fetchingEmails ? <CircularProgress size={20} /> : <EmailIcon />}
            ...
            <Box sx={{ 
                ...
                <Paper sx={{ 
                    ...
                    {/* Right Panel - Attachment Analysis */}
                    <Paper sx={{ width: '350px', overflow: 'hidden', display: 'flex', flexDirection: 'column' }}>
                        {!selectedEmail ? (
                            <Box sx={{ display: 'flex', alignItems: 'center', justifyContent: 'center', height: '100%' }}>
                                <Box sx={{ textAlign: 'center' }}>
                                ...
                                <Box sx={{ p: 2 }}>
                                    ...
                                    <Grid container spacing={2} sx={{ mb: 2 }}>
                                        ...
                                        <Grid item xs={12} sm={6}>
                                            <Box sx={{ display: 'flex', alignItems: 'center', mb: 1 }}>
                                                ...
                                                <Typography variant="body2" fontWeight="bold">Sender:</Typography>
                                            </Box>
                                            <Typography variant="body2">{selectedEmail.sender_address}</Typography>
                                        </Grid>
                                        ...
                                        <Grid item xs={12} sm={6}>
                                            <Box sx={{ display: 'flex', alignItems: 'center', mb: 1 }}>
                                                <BadgeIcon sx={{ mr: 1, color: 'primary.main', fontSize: 20 }} />
                                        ...
                                        <Grid item xs={12} sm={6}>
                                            <Box sx={{ display: 'flex', alignItems: 'center', mb: 1 }}>
                                                <NewReleasesIcon sx={{ mr: 1, color: 'primary.main', fontSize: 20 }} />
                                                <Typography variant="body2" fontWeight="bold">New Enquiry:</Typography>
                                            </Box>
                                            <FormControl size="small" fullWidth>
                                                <Select
                                                    value={humanConfirmation.isNewEnquiry}
                                        ...
                                        <Grid item xs={12}>
                                            <Box sx={{ display: 'flex', alignItems: 'center', mb: 1 }}>
                                                <AttachFileIcon sx={{ mr: 1, color: 'primary.main', fontSize: 20 }} />
                                                <Typography variant="body2" fontWeight="bold">
                                                    Attachments: {selectedEmail.parsed_attachments_json?.length || 0} file(s)
                                                </Typography>
                                            </Box>
                                        </Grid>
                                    </Grid>
                                    ...
                                    <Accordion>
                                        <AccordionSummary expandIcon={<ExpandMoreIcon />}>
                                            <Typography variant="body2" fontWeight="bold">📧 Email Content</Typography>
                                        </AccordionSummary>
                                        <AccordionDetails>
                                            {selectedEmail.email_summary && (
                                                <Box sx={{ mb: 2 }}>
                    ...
                    <Paper sx={{ width: '350px', overflow: 'hidden', display: 'flex', flexDirection: 'column' }}>
                        {!selectedEmail ? (
                            ...
                            <Box sx={{ height: '100%', overflow: 'auto' }}>
                                {/* Attachment Header */}
                                <Box sx={{ p: 1.5, borderBottom: 1, borderColor: 'divider', backgroundColor: '#f5f5f5' }}>
                                    <Typography variant="subtitle1" sx={{ fontSize: '0.9rem', fontWeight: 'bold' }}>
                                        📎 Attachments & Analysis
                                    </Typography>
                                    <Typography variant="body2" sx={{ fontSize: '0.75rem' }} color="text.secondary">
                                        {selectedEmail.parsed_attachments_json?.length || 0} attachment(s)
                                    </Typography>
                                </Box>
                                ...
                                <Box sx={{ p: 1.5 }}>
                                    ...
                                    {selectedEmail.parsed_attachments_json && selectedEmail.parsed_attachments_json.length > 0 ? (
                                        <Box sx={{ mb: 1.5 }}>
                                            <Typography variant="subtitle2" sx={{ fontSize: '0.8rem', fontWeight: 'bold' }} gutterBottom>
                                                Select files for analysis:
                                            </Typography>
                                            <Alert severity="info" sx={{ mb: 1.5, fontSize: '0.7rem', padding: '8px' }}>
                                                📄 Supported: PDF, Excel, Word
                                                <br />
                                                🚫 Images filtered automatically
                                            </Alert>
                                            <Box sx={{ mb: 1.5 }}>
                                                            ...
                                                            label={
                                                                <Box sx={{ display: 'flex', alignItems: 'center', gap: 0.5 }}>
                                                                    ...
                                                                    <Chip
                                                                        ...
                                                                        variant="outlined"
                                                                        sx={{ fontSize: '0.65rem', height: '18px', minWidth: '20px' }}
                                                                    />
                                                                </Box>
                                                            }
                                                ...
                                                {selectedAttachments.length > 0 && (
                                                    <Button
                                                        variant="outlined"
                                                        startIcon={loadingAttachment ? <CircularProgress size={16} /> : <PreviewIcon />}
                                                    ...
                                                    >
                                                        {loadingAttachment ? 'Analyzing...' : 'Analyze Selected'}
                                                    </Button>
                                                )}
                                            </Box>
                                        </Box>
                                        ...
                                        <Box>
                                            ...
                                            <Accordion size="small">
                                                <AccordionSummary expandIcon={<ExpandMoreIcon sx={{ fontSize: 16 }} />}>
                                                    <Typography variant="body2" sx={{ fontSize: '0.75rem', fontWeight: 'bold' }}>AI Summary</Typography>
                                                </AccordionSummary>
                                                <AccordionDetails sx={{ padding: '8px 16px' }}>
                                            ...
                                            {attachmentSummary.extractedData && (
                                                <Accordion size="small">
                                                    <AccordionSummary expandIcon={<ExpandMoreIcon sx={{ fontSize: 16 }} />}>
                                                        <Typography variant="body2" sx={{ fontSize: '0.75rem', fontWeight: 'bold' }}>Technical Details</Typography>
                                                    </AccordionSummary>
                                                    <AccordionDetails sx={{ padding: '8px 16px' }}>
                                                        <Paper sx={{ p: 1, backgroundColor: '#f5f5f5' }}>
                                                            <Typography variant="body2" sx={{ fontSize: '0.7rem' }}>
                                                                <strong>Document Type:</strong> {attachmentSummary.extractedData.documentType}
                                                            </Typography>
                                                            <Typography variant="body2" sx={{ mt: 0.5, fontSize: '0.7rem' }}>
                                                                <strong>Key Points:</strong>
                                                            </Typography>
                                                            <List dense sx={{ padding: 0 }}>
                                                                {attachmentSummary.extractedData.keyPoints.map((point, index) => (
                                                            ...
                                                            {attachmentSummary.extractedData.technicalDetails &&
                                                                Object.keys(attachmentSummary.extractedData.technicalDetails).length > 0 && (
                                                                    <Box sx={{ mt: 0.5 }}>
                                                                        <Typography variant="body2" sx={{ fontSize: '0.7rem' }}>
                                                                            <strong>Technical Details:</strong>
                                                                        </Typography>
                                                                        {Object.entries(attachmentSummary.extractedData.technicalDetails).map(([key, value]) => (
                                                                            <Typography key={key} variant="body2" sx={{ ml: 1, fontSize: '0.7rem' }}>

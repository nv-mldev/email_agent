...
graph TD
    ...
    %% --- Styling ---
    linkStyle 0,2 stroke:#3498db,stroke-width:2px,color:blue;
    linkStyle 1,3 stroke:#3498db,stroke-width:2px,color:blue;
    linkStyle 4,6 stroke:#2ecc71,stroke-width:2px;
    linkStyle 5,6 stroke:#2ecc71,stroke-width:2px;
    linkStyle 7 stroke:#2ecc71,stroke-width:2px;
    linkStyle 8 stroke:grey,stroke-width:2px,stroke-dasharray: 5 5;
